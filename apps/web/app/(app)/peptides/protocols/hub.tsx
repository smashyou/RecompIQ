        ...
        {TABS.map((t) => {
          ...
          return (
            <button
              ...
              onClick={() => go(t.id)}
              className={cn(
                "flex flex-1 items-center justify-center gap-2 whitespace-nowrap rounded-[var(--r-md)] px-2 py-2 font-[family-name:var(--font-sans)] text-xs font-medium transition-colors",
                active
